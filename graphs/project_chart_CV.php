...
<?php 		require("../dbconnect.php");
			...
			{
				$query = "SELECT ot.prj_desc,ot.F9, bm.FR_MN FROM MMR_OUTPUT_PRJ ot LEFT JOIN MMR_BRIEF_MASTER  bm ON bm.Brid = ot.brid WHERE bm.prj_id IN (".$_GET["get_project"].") AND bm.brid IN (".$_GET["brid"].") ";
			}
			else
			{
				$query = "SELECT prj_desc,F9,bm.FR_MN FROM MMR_OUTPUT_PRJ ot LEFT JOIN MMR_BRIEF_MASTER  bm ON bm.Brid = ot.brid";
			}	
